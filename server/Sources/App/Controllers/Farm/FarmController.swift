...
class FarmController: RouteCollection {
    ...
    private func setupTerritorialDiagnosisContainer (req: Request, farmId: UUID) throws -> EventLoopFuture<HTTPStatus>{
        ...
        let territorialDiagContainer = StagesContainer.Inoutput(type: .territorialDiagnosis, stages: territorialStages, id: UUID(), farmId: farmId, name: "Diagnóstico Territorial", desc: "")
    ...
    private func setupSocialMobContainer (req: Request, farmId: UUID) throws -> EventLoopFuture<HTTPStatus>{
        ...
        let socialMobContainer = StagesContainer.Inoutput(type: .socialMobilization, stages: socialStages, id: UUID(), farmId: farmId, name: "Mobilização Social", desc: "")
    ...
    private func setupEnvironmentalContainer (req: Request, farmId: UUID) throws ->  EventLoopFuture<HTTPStatus>{
        ...
        let environmentContainer = StagesContainer.Inoutput(type: .environmentalStudy, stages: environmentStages, id: UUID(), farmId: farmId, name: "Estudo Ambiental", desc: "")
    ...
    private func setupDescMemorialContainer (req: Request, farmId: UUID) throws -> EventLoopFuture<HTTPStatus>{
        ...
        let descMemorialContainer = StagesContainer.Inoutput(type: .descriptiveMemorial, stages: descMemorialStages, id: UUID(), farmId: farmId, name: "Memorial Descritivo", desc: "")
